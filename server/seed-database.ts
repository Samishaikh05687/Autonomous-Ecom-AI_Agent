...
async function createItemSummary(item: Item): Promise<string> {
  ...
  return new Promise((resolve) => {
    ...
    const price = `At full price it costs: ${item.prices.full_price} Rupees, On sale it costs: ${item.prices.sale_price} Rupees`
